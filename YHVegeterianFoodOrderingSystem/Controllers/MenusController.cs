...
namespace YHVegeterianFoodOrderingSystem.Views
{
    public class MenusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FoodName,Price,Quantity")] Menu menu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FoodName,Price,Quantity")] Menu menu)
        {
            if (id != menu.Id)
            {
                return NotFound();
